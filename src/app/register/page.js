    ...
    <div className="min-h-screen flex items-center justify-center py-12 px-4 sm:px-6 lg:px-8 relative overflow-hidden">
      ...
      <div className="w-full max-w-md relative z-10">
        ...
        >
          ...
          <h1 className="text-3xl font-bold text-foreground mb-2">Bergabung dengan Studio</h1>
          <p className="text-zinc-400">Buat akun baru dan mulai berbagi template Anda</p>
        </motion.div>
